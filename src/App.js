      ...
      <div style={{ flex: 1, overflowY: "auto" }}>
        ...
        <div style={{ margin: "4px 18px 8px" }}>
          ...
          <div style={{ background: "white", borderRadius: 14, overflow: "hidden", border: "1px solid rgba(82,183,136,0.1)" }}>
            ...
            <div onClick={() => window.open("https://instagram.com/meetfree.uk", "_blank")} style={{ padding: "13px 18px", cursor: "pointer", borderBottom: "1px solid rgba(82,183,136,0.08)", display:"flex", alignItems:"center", gap:8 }}><span style={{ fontSize:16 }}>📷</span><span style={{ fontWeight: 600, fontSize: 14, color: theme.greenDeep }}>Follow us on Instagram</span></div>
            <div onClick={() => window.open("https://www.facebook.com/profile.php?id=61590732057649", "_blank")} style={{ padding: "13px 18px", cursor: "pointer", borderBottom: "1px solid rgba(82,183,136,0.08)", display:"flex", alignItems:"center", gap:8 }}><span style={{ fontSize:16 }}>👍</span><span style={{ fontWeight: 600, fontSize: 14, color: theme.greenDeep }}>Follow us on Facebook</span></div>
